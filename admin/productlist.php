             ...
             <table class="table tablesorter " id="page1">
               ...
               <tbody>
                 <?php
                  ...
                  $result = mysqli_query($con, "select product_id,product_image, product_title,product_price from products  where  product_cat=2 or product_cat=3 or product_cat=4 or product_cat=5 or product_cat=6 or product_cat=7 Limit $page1,12") or die("query 1 incorrect.....");
